...
The (q promise library)[https://github.com/kriskowal/q] is widely used in Node applications, especially those that use AngularJS on the front end. This is because AngularJS has a version of q built into it.
